...
namespace UnityStandardAssets.Vehicles.Aeroplane
{
    ...
    public class AeroplaneController : MonoBehaviour
    {
        ...
        [SerializeField] private float m_AutoRollLevel = 0.02f;        // How much the aeroplane tries to level when not rolling.
        [SerializeField] private float m_AutoPitchLevel = 0.02f;       // How much the aeroplane tries to level when not pitching.
        ...
        private void Start()
        {
			...
			for (int i = 0; i < transform.childCount; i++ )
			{
				...
				{
					componentsInChild.motorTorque = .18f;           
				}
			}
        }
        ...
        private void AutoLevel()
        {
            ...
            if (RollInput == 0f)
            {
                RollInput = RollInput = -RollAngle*m_AutoRollLevel;
            }
